...
// do not edit this file! it's automatically generated by set-target.sh based on the contents of src/arch/<current arch>/build.rs and src/platform/<current platform>/build.rs
...
EOF
cat kernel/src/arch/$ARCH/build.rs >> kernel/build.rs
cat >> kernel/build.rs <<EOF
    }
    { /* ==== platform-specific build steps ==== */
EOF
cat kernel/src/platform/$PLATFORM/build.rs >> kernel/build.rs
cat >> kernel/build.rs <<EOF
    }
}
EOF
